...
Every source file carries an SPDX header; new files need one too. Note this
differs from Ultron Wear, which is MIT — Atomix Wear is a Mark VI component and
inherits Mark VI's copyleft.
